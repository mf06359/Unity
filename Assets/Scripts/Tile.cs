...
public class Tile : MonoBehaviour
{
    ...
    private IEnumerator SmoothMove(Vector3 target, bool rotate)
    {
        ...
        {
            targetRotation = (rotate && GameManager.instance.playerManager.activePlayerId == GameManager.instance.playerManager.id &&  GameManager.instance.playerManager.turnCount == GameManager.instance.playerManager.riichiTurn) ? Quaternion.Euler(0, 0, 90) : transform.rotation; // âÒì]èàóùÇà¯êîÇ≈êßå‰
        }
