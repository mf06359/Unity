...
public class Panel : MonoBehaviour
{
    ...
    private int flippedDoraCount = 0;
    ...
    public void ShowKakanTile(Player player, int kakanTile)
    {
    ...
    public void ShowMachiTiles(Player player, int tileInt) { SaveTilesInPanel(player, tileInt); }
